...
CModule::AddAutoloadClasses("tkkit.api", array(
	"CAkop" => "classes/general/CAkop.php",
	"CKitApi" => "classes/general/CKitApi.php",
	"CKitCity" => "classes/general/CKitCity.php",
	"CKitStore" => "classes/general/CKitStore.php",
	"CKitFreight" => "classes/general/CKitFreight.php",
	"CKitPrice" => "classes/general/CKitPrice.php",
));

/*
Class CTkkitDelivery 
{
