...
$APPLICATION->SetPageProperty("keywords", $arResult["PROPERTIES"]["NAME_BRANCH"]["VALUE"] 
		...
		. $arResult["PROPERTIES"]["NAME_BRANCH"]["VALUE"] 
...
<div class="filial" id="<?=$this->GetEditAreaId($arResult['ID']);?>" data-id="<?=$arResult["ID"]?>" data-name="<?=$arResult["NAME"]?>"
	...
	<div class="presentation">
		<p>
			Через Транспортную компанию КИТ Вы всегда можете перевезти свой груз (до 20 тонн) или грузик (от 1 кг) по очень низким ценам. Мы перевезем Ваш груз дешево, но качественно. А наши доброжелательные сотрудники всегда помогут Вам соориентироваться в мире перевозок сборных грузов.
		</p>
		<p>
			Отправьте свой груз из г.<?=$arResult["DISPLAY_PROPERTIES"]["NAME_BRANCH"]["VALUE"]?> в <a href="/contacts/">г.Ярославль</a> (или любой из наших <a href="/filials/">более 100 филиалов</a>) или в обратном направлении и Вы убедитесь, что наши <a href="/redirect/tariff.php">цены</a> весьма умеренные. Качеством перевозки Вы тоже останетесь довольны.
		</p>
	</div>
