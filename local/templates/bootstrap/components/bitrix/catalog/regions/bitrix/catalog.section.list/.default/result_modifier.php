...
if (0 < $arResult['SECTIONS_COUNT'])
{
	...
	$arResult["PROPS"] = array("REGIM", "PHONE", "EMAIL", "ADRES", "MAP", "SXEMA");
	// $arResult["PROPS22"] = array("EMAIL", "ADRES", "MAP");
	...
	$list = CIBlockElement::GetList(
		array("IBLOCK_SECTION_ID" => "ASC", "ID" => "ASC", "NAME" => "ASC"),
		// array("IBLOCK_ID" => 7), 
		array("IBLOCK_ID" => 8, "IBLOCK_SECTION_ID" => false), 
		false, 
		false, 
		$arSelect
		// array("ID", "NAME", "IBLOCK_SECTION_ID", "PROPERTY_regim", "PROPERTY_phone", "PROPERTY_email", "PROPERTY_adres", "PROPERTY_map", "PROPERTY_sxema" 	)
		// array("ID", "NAME", "IBLOCK_SECTION_ID")
		// false
	);
	
	while ($el = $list->Fetch()) {
		$arResult["FILIALS"][$el["IBLOCK_SECTION_ID"]][] = $el;
		// $arResult["FILIALS"][$el["IBLOCK_SECTION_ID"]][$el["ID"]] = $el;
	}	


// echo '<pre>'; print_r($arResult["PROPS"]); echo '</pre>';
// echo '<pre>'; print_r($arResult["PROPS22"]); echo '</pre>';
